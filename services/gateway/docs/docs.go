...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreateAIProviderModelRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ai/providers/{model}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "AI 模型配置更新参数",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateAIProviderModelRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/documents/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "文档元数据更新参数",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateDocumentMetaRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SyncCollabContentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/workspaces/{id}/files/{file_id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "文件元数据更新参数",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateWorkspaceFileRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateWorkspaceMemberRoleRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "request.SyncCollabContentRequest": {
            "type": "object",
            "required": [
                "content_json"
            ],
        ...
        "request.UpdateAIProviderModelRequest": {
            "type": "object",
            "properties": {
                "api_key": {
                    "type": "string",
        ...
        "request.UpdateDocumentMetaRequest": {
            "type": "object",
            "properties": {
                "clear_folder": {
                    "type": "boolean"
